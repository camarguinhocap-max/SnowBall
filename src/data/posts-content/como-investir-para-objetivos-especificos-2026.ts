...
Renda fixa conservadora e líquida
- Tesouro Selic
...
**Investimento adequado:**
Mix de renda fixa e variável com maior componente fixo no início
...
**Investimento adequado:**
Foco em crescimento com maior exposição a renda variável
- 40-60% Ações e ETFs
- 20-30% FIIs
...
| Objetivo | Alocação Mensal | Prazo | Produto |
|---|---|---|---|
| Viagem Europa | R$ 300 | 2 anos | CDB diário |
| Troca de carro | R$ 400 | 4 anos | CDB/LCA |
| Aposentadoria | R$ 600 | 25 anos | ETFs + FIIs |
| Reserva geral | R$ 200 | Sem prazo | Tesouro Selic |
...
Curto prazo = conservador (você não pode correr risco de precisar do dinheiro na baixa)
Longo prazo = mais ousado (o tempo absorve a volatilidade e amplifica o crescimento)
...
Para entender melhor as opções de renda fixa para objetivos de curto e médio prazo, veja [investimentos seguros em tempos de juros altos em 2026](/post/investimentos-seguros-em-tempos-de-juros-altos-2026).
    `;
