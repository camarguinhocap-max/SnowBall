...
**Você é financeiramente independente quando:**
Sua renda passiva (dividendos, aluguéis, rendimentos) ≥ seus gastos mensais
...
**Meta:** Controle total do orçamento por 3 meses consecutivos.

### Estágio 2 — Segurança financeira
Você tem uma reserva de emergência e zero dívidas com juros altos.
**Meta:** 6 meses de gastos em liquidez e cartão sempre pago no total.

### Estágio 3 — Acumulação
Você investe consistentemente todos os meses e seu patrimônio cresce.
**Meta:** Investir pelo menos 20% da renda mensalmente.

### Estágio 4 — Independência parcial
Sua renda passiva cobre pelo menos 30-50% dos seus gastos.
**Meta:** Reduzir dependência do trabalho principal.

### Estágio 5 — Independência total
Sua renda passiva cobre 100% dos gastos.
**Meta:** Trabalhar porque quer, não porque precisa.
...
| Taxa de Poupança | Tempo estimado para IF* |
|---|---|
| 10% da renda | 43 anos |
| 20% da renda | 35 anos |
| 30% da renda | 28 anos |
...
Para entender melhor como montar uma carteira de investimentos que gere renda passiva, veja [como montar uma carteira de dividendos do zero](/post/como-montar-carteira-dividendos-2026).
    `;
