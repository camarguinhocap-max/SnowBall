...
![Teclado de computador com tecla vermelha 'TAX' ao lado de documentos fiscais](https://images.unsplash.com/photo-1554224154-26032ffc0d04?auto=format&fit=crop&w=1200&q=70)

---

## 1. A Revolução da Declaração Pré-Preenchida

A grande mudança dos últimos anos, que se consolidou em 2026, foi a **Declaração Pré-Preenchida**. 
Acessível para todos os cidadãos que possuem conta Gov.br nos níveis Prata ou Ouro, essa modalidade é um verdadeiro salva-vidas.
...
Consultas particulares (médicos, dentistas, psicólogos, fisioterapeutas), exames laboratoriais, internações e a mensalidade do plano de saúde podem ser deduzidos integralmente. Não há limite de valor.
*Regra de Ouro:* Guarde todos os recibos e notas fiscais (com o CPF do profissional) por 5 anos. Se cair na malha fina, a comprovação é documental.
...
A ferramenta mais poderosa de dedução fiscal no Brasil é o **PGBL** (Plano Gerador de Benefício Livre).
Se você faz a declaração no modelo Completo, pode aplicar até 12% da sua renda tributável bruta anual em um PGBL. Esse valor é abatido integralmente da sua base de cálculo. É o equivalente a "esconder" legalmente 12% do seu salário do Leão, transferindo o imposto para o momento do resgate no futuro (idealmente na tabela regressiva de 10%).
