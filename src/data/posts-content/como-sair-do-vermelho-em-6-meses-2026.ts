...
| Dívida | Credor | Saldo Total | Taxa de Juros | Parcela Mensal |
|---|---|---|---|---|
| Cartão X | Banco A | R$ 3.500 | 12% a.m. | R$ 250 |
| Empréstimo | Banco B | R$ 8.000 | 3% a.m. | R$ 400 |
| Carnê loja | Loja C | R$ 1.200 | 0% a.m. | R$ 200 |
...
Ações:
- Com 1-2 dívidas a menos, o fluxo de caixa melhora. Use esse excedente para:
  a) Pagar mais rápido as dívidas restantes
  b) Reforçar a reserva de emergência
...
Para entender como negociar suas dívidas e conseguir os maiores descontos, leia [como negociar dívidas e conseguir descontos de até 90%](/post/como-negociar-dividas-e-conseguir-descontos-2026).
    `;
