...
**Rentabilidade:** Acompanha 100% da Selic (em 2026, aproximadamente 10,5% a.a.)
**Liquidez:** Resgata em D+1 (1 dia útil)
**Onde comprar:** Plataforma do Tesouro Direto, Nubank, XP, Rico e outras corretoras
**Mínimo:** A partir de R$ 100
...
**Rentabilidade:** 100-105% do CDI (próximo à Selic)
**Liquidez:** Diária (D+0 ou D+1)
**Garantia:** FGC até R$ 250.000 por instituição
**Mínimo:** Geralmente R$ 1

✅ Tão fácil quanto poupança
✅ Mais rentável
✅ Garantido pelo FGC
...
**Rentabilidade:** Geralmente 85-95% do CDI, mas sem IR o retorno líquido é melhor que a poupança
**Liquidez:** Menor — normalmente com prazo de 3 a 12 meses de carência
...
| Produto | Rentabilidade Bruta | IR | Retorno Líquido | Valor Final |
|---|---|---|---|---|
| Poupança | 6,17% | Isento | 6,17% | R$ 10.617 |
| Tesouro Selic | 10,50% | 17,5%* | 8,66% | R$ 10.866 |
| CDB 100% CDI | 10,50% | 17,5%* | 8,66% | R$ 10.866 |
| LCA 90% CDI | 9,45% | Isento | 9,45% | R$ 10.945 |
...
Para entender o imposto de renda sobre esses investimentos, veja [o guia de IR sobre investimentos](/post/imposto-de-renda-sobre-investimentos).
    `;
