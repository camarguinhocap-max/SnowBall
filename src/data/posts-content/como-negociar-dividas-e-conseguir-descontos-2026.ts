...
3. Veja suas dívidas listadas
4. Clique em "Ver oferta" para cada dívida
5. Escolha à vista (desconto máximo) ou parcelado
...
1. **Guarde o comprovante** de quitação por pelo menos 5 anos
2. **Verifique em 5 dias úteis** se o nome saiu dos cadastros de inadimplência
3. **Se o nome não sair**, protocole reclamação no Procon
4. **Não repita o erro:** entenda o que gerou a dívida e corrija o comportamento financeiro
...
Para entender como montar um plano para sair do vermelho em 90 dias, leia [o guia completo para sair das dívidas em 90 dias](/post/guia-completo-para-sair-das-dividas-em-90-dias).
    `;
