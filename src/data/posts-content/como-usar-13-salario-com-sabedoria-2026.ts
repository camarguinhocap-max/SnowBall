...
|---|---|---|
| Quitar cartão de crédito | R$ 2.000 | Elimina juros de 12% ao mês |
| Reforço da reserva de emergência | R$ 1.500 | Segurança financeira |
| Investimento (CDB 110% CDI) | R$ 700 | Dinheiro trabalhando por você |
| Lazer planejado | R$ 300 | Recompensa consciente |
...
Para aprofundar sua estratégia de investimentos, veja também [como montar uma carteira para o segundo semestre de 2026](/post/planejamento-financeiro-para-casais-2026).
    `;
