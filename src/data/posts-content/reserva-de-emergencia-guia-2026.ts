...
![Mãos segurando uma planta crescendo a partir de moedas empilhadas](https://images.unsplash.com/photo-1579621970563-ebec7560ff3e?auto=format&fit=crop&w=1200&q=70)
...
**A ausência de uma reserva é o principal motivo do endividamento no Brasil.**
...
1. **Para funcionários públicos ou com extrema estabilidade:**
   Seu risco de demissão é baixíssimo. Portanto, sua reserva pode ser menor: **3 a 6 meses** do seu custo de vida. (Exemplo: Se você gasta R$ 3.000 por mês para sobreviver, sua reserva deve ser entre R$ 9.000 e R$ 18.000).

2. **Para funcionários CLT na iniciativa privada:**
   Existe o risco real de demissão, mas você conta com o amortecedor do Seguro-Desemprego e do FGTS. O ideal é ter **6 a 9 meses** do seu custo de vida.

3. **Para Autônomos, Freelancers e Empreendedores:**
   Se você não trabalhar (por quebrau um braço, por exemplo), você não ganha. Não há rescisão ou FGTS. O risco é máximo. Para esse perfil, a reserva deve cobrir de **9 a 12 meses** (um ano inteiro) de sobrevivência.
