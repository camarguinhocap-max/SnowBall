...
**Desvantagem:** Demora mais para ver uma dívida zerando
...
**Vantagem:** Você vê dívidas sendo eliminadas rapidamente — isso dá motivação
...
|---|---|
| Dívida com juros > 20% a.a. | Quite imediatamente, prioridade máxima |
| Dívida com juros de 12-20% a.a. | Quite primeiro, depois invista |
| Dívida com juros de 8-12% a.a. | Quite e invista simultaneamente |
| Dívida com juros < 8% a.a. | Mantenha pagamento e invista o excedente |
| Sem dívidas | Invista pelo menos 20% da renda |
...
Para entender melhor como organizar dívidas e sair do vermelho, veja [como sair das dívidas de uma vez por todas](/post/como-sair-das-dividas-de-uma-vez-por-todas).
    `;
