...
Juros altos têm um lado bom para quem investe: a renda fixa paga mais. Em 2026, com a Selic em patamar elevado, os investimentos de menor risco nunca foram tão atrativos.
...
**Rentabilidade:** Selic atual (~10,5% a.a.)
**Risco:** Mínimo — garantido pelo governo federal
**Liquidez:** D+1 (resgate em 1 dia útil)
**IR:** Regressivo (22,5% em menos de 6 meses até 15% acima de 2 anos)
**Mínimo:** ~R$ 100
...
**Risco:** Baixo — garantido pelo FGC até R$ 250.000 por instituição
...
**Rentabilidade:** 110-120% do CDI (ou mais)
**Risco:** Baixo — FGC até R$ 250.000
**Liquidez:** Somente no vencimento (6, 12, 24 meses)
**IR:** Regressivo
**Mínimo:** R$ 1.000-5.000 (varia)
...
**Rentabilidade:** 85-95% do CDI (menor que o CDB, mas sem IR)
**Risco:** Baixo — FGC
**Liquidez:** Carência de 90 a 360 dias (varia)
**IR:** Isento para pessoa física
**Mínimo:** R$ 1.000-5.000
...
**Rentabilidade:** IPCA + taxa prefixada (ex: IPCA + 6,5% a.a.)
**Risco:** Baixo — garantido pelo governo, mas pode ter perdas no curto prazo se vender antes do vencimento
**Liquidez:** Venda diária (mas preço oscila antes do vencimento)
**IR:** Regressivo
**Mínimo:** ~R$ 100
...
|---|---|---|---|---|
| Poupança | 6,17% | 0% | 6,17% | R$ 53.085 |
| Tesouro Selic | 10,5% | 17,5% | 8,66% | R$ 54.330 |
| CDB 110% CDI | 11,55% | 17,5% | 9,53% | R$ 54.765 |
| LCA 91% CDI | 9,56% | 0% | 9,56% | R$ 54.780 |
| CDB 115% CDI | 12,08% | 17,5% | 9,97% | R$ 54.985 |
...
| Valor | Produto | Prazo | Objetivo |
|---|---|---|---|
| R$ 10.000 | CDB liquidez diária | Sem prazo | Reserva de emergência |
| R$ 20.000 | LCA 92% CDI | 6 meses | Objetivo de médio prazo |
| R$ 20.000 | CDB 115% CDI | 12 meses | Maior rentabilidade |
...
❌ **Poupança** — perde para opções equivalentes em segurança
❌ **Renda variável para reserva de emergência** — o risco não vale quando a renda fixa paga bem
❌ **Fundos de renda fixa com taxa de administração alta** — se o fundo cobra 1,5% a.a. e o CDB paga 110% CDI, você perde mais para a taxa do que o fundo te beneficia
❌ **Investimento em banco grande por "segurança"** — os grandes bancos pagam menos. O FGC garante R$ 250.000 em qualquer banco associado
...
Para entender melhor as diferenças entre os títulos do Tesouro Direto, veja [renda fixa: guia completo dos títulos do Tesouro Direto](/post/renda-fixa-titulos-do-tesouro-direto).
    `;
