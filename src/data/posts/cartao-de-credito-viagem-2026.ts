...
export const post: Post = {
  slug: 'cartao-de-credito-viagem-2026',
  title: 'Cartão de Crédito para Viagens: Como Acumular Milhas de Verdade',
  excerpt: 'Descubra quais cartões valem mais pena para acumular milhas aéreas no Brasil em 2026, como maximizar a conversão de pontos e os erros clássicos que jogam suas milhas fora.',
  tags: ['milhas', 'cartão de crédito', 'viagens', 'pontos', 'benefícios'],
  category: 'Finanças Pessoais',
  date: '20 Jun 2026',
  readTime: '11 min de leitura',
  image: '/assets/images/cartao-de-credito-viagem-2026.jpg',
  content: `
...
1. **Cartão de crédito**: Cada compra gera uma quantidade de pontos com base em uma taxa de conversão (ex: 1,5 ponto por real gasto).
2. **Programa de fidelidade do cartão**: Os pontos ficam armazenados em programas como Livelo, Esfera, Vai de Bob ou TudoAzul.
3. **Programa de fidelidade da companhia aérea**: Os pontos do cartão são transferidos (com uma taxa de conversão) para programas como LATAM Pass, Smiles (GOL) ou TudoAzul (Azul), onde a passagem é efetivamente emitida.
...
![Passaporte e cartão de crédito sobre mapa mundial com avião em miniatura](https://images.unsplash.com/photo-1488646953014-85cb44e25828?auto=format&fit=crop&w=1200&q=70)
