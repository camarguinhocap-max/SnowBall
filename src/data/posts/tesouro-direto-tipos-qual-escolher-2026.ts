...
export const post: Post = {
  slug: 'tesouro-direto-tipos-qual-escolher-2026',
  title: 'Tesouro Direto: Qual Tipo Escolher em 2026?',
  excerpt: 'Guia definitivo para escolher entre Tesouro Selic, Prefixado e IPCA+ em 2026, com exemplos práticos de quando cada um faz mais sentido para seu objetivo e perfil de investidor.',
  tags: ['Tesouro Direto', 'renda fixa', 'Tesouro Selic', 'Tesouro IPCA', 'prefixado', 'investimentos'],
  category: 'Renda Fixa',
  date: '27 Jun 2026',
  readTime: '12 min de leitura',
  image: '/assets/images/tesouro-direto-tipos-qual-escolher-2026.jpg',
  content: `
O Tesouro Direto é, sem dúvida, o produto de investimento mais democratizante da história financeira brasileira. Criado em 2002, ele permite que qualquer cidadão com CPF e conta em uma corretora parceira invista em títulos do governo federal a partir de R$ 30. Com baixo risco de crédito (é garantido pelo Tesouro Nacional, a entidade mais segura do país) e excelente rentabilidade, deveria estar na carteira de praticamente todos os investidores brasileiros.
...
![Gráfico de barras coloridas representando diferentes tipos de investimento em renda fixa](https://images.unsplash.com/photo-1551288049-bebda4e38f71?auto=format&fit=crop&w=1200&q=70)
...
| Aposentadoria / horizonte 10+ anos | Tesouro IPCA+ |
| Aposta em queda da Selic (especulativo) | Prefixado longo ou IPCA+ longo |
| Renda mensal / semestral | NTN-B com cupom semestral |
| Não sei quando vou precisar | Tesouro Selic (sempre) |
