...
export const post: Post = {
  ...
  title: 'Aposentadoria: Como Se Planejar do Jeito Certo',
  excerpt: 'Aprenda a estruturar seu plano de aposentadoria de forma realista, os desafios da previdência pública e como calcular o patrimônio necessário para a sua liberdade.',
  tags: ['aposentadoria', 'planejamento', 'investimentos', 'independência financeira'],
  category: 'Aposentadoria',
  date: '30 Mai 2026',
  readTime: '14 min de leitura',
  image: '/assets/images/aposentadoria-planejamento.jpg',
  content: `
A ideia tradicional de trabalhar por 35 ou 40 anos, recolher a contribuição mensal e se aposentar de forma confortável dependendo exclusivamente da previdência social pública (INSS) está se tornando uma fantasia matemática no Brasil. A combinação do rápido envelhecimento populacional com a redução da taxa de natalidade pressiona o sistema de repartição simples (onde quem trabalha paga a aposentadoria de quem já se aposentou). Em 2026, planejar a própria aposentadoria tornou-se uma necessidade de sobrevivência financeira.
...
![Pessoa idosa sentada sorrindo ao ar livre em um banco com óculos de leitura](https://images.unsplash.com/photo-1544027993-37dbfe43562a?auto=format&fit=crop&w=1200&q=70)
...
*Cálculo Prático*:
Se você quer uma renda mensal de **R$ 5.000** (ou R$ 60.000 por ano), e considera uma taxa de retirada conservadora de 6% real ao ano:
