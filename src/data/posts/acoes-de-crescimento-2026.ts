...
export const post: Post = {
  slug: 'acoes-de-crescimento-2026',
  title: 'Ações de Crescimento para 2026',
  excerpt: 'Onde estão as oportunidades de valorização na bolsa.',
  date: '11 Jun 2026',
  readTime: '5 min de leitura',
  category: 'Renda Variável',
  tags: ['ações', 'crescimento'],
  image: '/assets/images/acoes-de-crescimento-2026.jpg',
  content: `
...
![Gráfico de linha verde subindo acentuadamente com números de mercado](https://images.unsplash.com/photo-1611974789855-9c2a0a7236a3?auto=format&fit=crop&w=1200&q=70)
...
1. **O Núcleo (70% a 80% do patrimônio em Renda Variável):** Invista em ETFs de índices globais (como o S&P 500), grandes empresas consolidadas pagadoras de dividendos, fundos imobiliários e renda fixa. Isso garante a segurança e a base do seu patrimônio.
2. **O Satélite (20% a 30%):** Reserve essa parcela para montar uma "cesta" de 5 a 10 ações de altíssimo crescimento. 
