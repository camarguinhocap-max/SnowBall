...
export const post: Post = {
        slug: 'carteira-60-40-morta-estrategias-alocacao-2026',
        title: 'Carteira 60/40 está morta? Novas estratégias de alocação de ativos para 2026',
        excerpt: 'O modelo clássico de 60% ações e 40% renda fixa não protege mais como antigamente. Descubra como montar uma carteira resiliente na nova economia de 2026.',
        tags: ['investimentos', 'alocacao', 'estrategia', 'carteira', 'diversificacao'],
        category: 'Investimentos',
        date: '03 Mai 2026',
        readTime: '18 min de leitura',
        image: '/assets/images/carteira-60-40-morta-estrategias-alocacao-2026.jpg',
        content: `
...
![Gráficos financeiros em telas de computador mostrando análise complexa](https://images.unsplash.com/photo-1611974789855-9c2a0a7236a3?auto=format&fit=crop&w=1200&q=70)
...
1. **Ações caem**: O custo de capital das empresas sobe e o lucro futuro passa a valer menos hoje.
2. **Títulos de renda fixa antigos caem**: Por causa da marcação a mercado, títulos que pagavam juros baixos perdem valor quando novos títulos passam a pagar juros mais altos.
...
![Múltiplos caminhos em uma estrada rural divergindo, simbolizando escolhas de diversificação](https://images.unsplash.com/photo-1506744626753-1fa44df31c7e?auto=format&fit=crop&w=1200&q=70)
