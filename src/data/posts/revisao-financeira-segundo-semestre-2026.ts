...
export const post: Post = {
  slug: 'revisao-financeira-segundo-semestre-2026',
  title: 'Revisão Financeira do 1º Semestre: O Que Ajustar para o 2º Semestre de 2026',
  excerpt: 'Faça um diagnóstico completo do seu desempenho financeiro no primeiro semestre de 2026 e descubra os ajustes estratégicos para maximizar seus resultados até o final do ano.',
  tags: ['planejamento financeiro', 'revisão anual', 'metas', 'segundo semestre', 'investimentos'],
  category: 'Planejamento Financeiro',
  date: '30 Jun 2026',
  readTime: '11 min de leitura',
  image: '/assets/images/revisao-financeira-segundo-semestre-2026.jpg',
  content: `
...
1. **Ainda dá tempo de corrigir**: Com 6 meses pela frente, você ainda pode acelerar a poupança, reequilibrar a carteira ou eliminar uma dívida antes do fechamento do ano.
2. **O cenário mudou**: O Brasil de junho é diferente do Brasil de janeiro. A Selic pode ter subido ou descido, o câmbio oscilou, algum FII cortou dividendos ou uma ação decolou. A carteira precisa ser reavaliada à luz do cenário atual.
3. **Reforça o compromisso**: Revisar o progresso é motivador. Ver que você poupou R$ 18.000 em 6 meses quando a meta anual era R$ 30.000 dá o combustível emocional para chegar ao fim.
...
![Pessoa fazendo revisão financeira com notebook, caderno e xícara de café em mesa organizada](https://images.unsplash.com/photo-1506784983877-45594efa4cbe?auto=format&fit=crop&w=1200&q=70)
