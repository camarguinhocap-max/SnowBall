...
export const post: Post = {
        slug: 'guia-imposto-de-renda-2026-investidores',
        title: 'Imposto de Renda 2026: O Guia Definitivo para Investidores e Criptoativos',
        excerpt: 'As regras mudaram e a Receita Federal está mais vigilante do que nunca. Entenda como declarar suas ações, FIIs, Renda Fixa e Cripto no IR 2026 sem erros.',
        tags: ['impostos', 'ir-2026', 'declaracao', 'investimentos', 'receita-federal'],
        category: 'Impostos e Legislação',
        date: '01 Mai 2026',
        readTime: '25 min de leitura',
        content: `# Imposto de Renda 2026: O Guia Definitivo para Investidores e Criptoativos

![Guia IR 2026](/posts/guia_ir_2026_investidores.png)
...
💡 **Dica de Leitura:** Entenda mais sobre o cenário macro que gerou essas mudanças em nosso artigo sobre a [Reforma Tributária 2026 e seus impactos no bolso do brasileiro](/post/reforma-tributaria-2026).

👉 **Ferramenta Recomendada:** Para não se perder nos cálculos e manter seus documentos organizados, confira estas [opções de scanners portáteis e organizadores de documentos na Amazon](https://www.amazon.com.br/s?k=scanner+portatil+documentos&tag=ofertaspri0ee), indispensáveis para quem leva a sério a gestão documental e fiscal.
        `
    };
