...
export const post: Post = {
  slug: 'planejamento-aposentadoria-2026-09-mai',
  title: 'Planejamento de Aposentadoria 2026: O Guia Completo para Garantir Seu Futuro',
  excerpt: 'Descubra os passos essenciais para começar a planejar sua aposentadoria ainda este ano. Da regra dos 25× ao PGBL/VGBL, tudo o que você precisa saber para ter tranquilidade financeira.',
  tags: ['aposentadoria', 'planejamento', 'previdência', 'investimento', 'longo prazo'],
  category: 'Aposentadoria',
  date: '09 Mai 2026',
  readTime: '14 min de leitura',
  image: '/assets/images/planejamento-aposentadoria-2026-09-mai.jpg',
  content: `
...
![Casal maduro planejando finanças em mesa com laptop](https://images.unsplash.com/photo-1556742049-0cfed4f6a45d?auto=format&fit=crop&w=1200&q=70)
...
1. Calcule suas despesas mensais desejadas na aposentadoria (ex.: R$ 8.000).
2. Multiplique por 12 para obter o custo anual: R$ 96.000.
3. Multiplique por 25: **R$ 2.400.000**.
...
![Gráfico de crescimento financeiro com moedas empilhadas](https://images.unsplash.com/photo-1554224155-6726b3ff858f?auto=format&fit=crop&w=1200&q=70)
...
| Critério | PGBL | VGBL |
|----------|------|------|
| Dedução IR | Até 12% da renda bruta | Não deduz |
| Tributação no resgate | Sobre valor total | Somente sobre rendimentos |
| Ideal para | Quem declara IR no modelo completo | Quem usa simplificado ou já esgotou os 12% |
...
![Documentos financeiros e calculadora sobre mesa](https://images.unsplash.com/photo-1450101499163-c8848c66ca85?auto=format&fit=crop&w=1200&q=70)

## 4. Contribuição automática: a disciplina que enriquece

O segredo é automatizar:

1. **Defina um percentual fixo da renda** (mínimo 15%, ideal 20–25%).
2. **Configure débito automático** no dia do pagamento para que o dinheiro nem passe pela conta corrente.
3. **Aumente o aporte anualmente** — cada aumento salarial deve incluir incremento proporcional nos investimentos.
4. **Nunca resgate antes da hora** — a multa emocional e financeira é enorme.
...
1. **Depender só do INSS** — o teto é baixo e as regras mudam a cada reforma.
2. **Começar tarde** — cada década perdida triplica o esforço necessário.
3. **Não considerar inflação** — R$ 10.000 hoje valerão R$ 5.000 em 15 anos a 5% de inflação.
4. **Resgatar a previdência no primeiro aperto** — destrói anos de acumulação.
5. **Ignorar seguros** — um problema de saúde pode consumir décadas de poupança.

![Pessoa idosa sorrindo em parque ao ar livre](https://images.unsplash.com/photo-1447005497901-b3e9ee359928?auto=format&fit=crop&w=1200&q=70)
