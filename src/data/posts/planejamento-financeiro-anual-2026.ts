...
![Agenda, caneta e óculos sobre uma mesa organizando o tempo](https://images.unsplash.com/photo-1506784365847-bbad939e9335?auto=format&fit=crop&w=1200&q=70)
...
Metade da sua renda líquida (o dinheiro que efetivamente cai na conta após impostos) deve ser o limite máximo para manter você vivo e abrigado. Moradia, transporte, saúde, contas de consumo e alimentação básica entram aqui. 
Se você ganha R$ 5.000 e gasta R$ 3.500 apenas para "existir" (70%), você tem um problema estrutural. Terá que mudar para um lugar mais barato, vender o carro financiado ou encontrar uma forma de aumentar rapidamente a sua renda.

### 30% para Desejos (Seu Estilo de Vida)
O planejamento não deve ser um monastério. Você trabalha duro e precisa desfrutar da vida no presente. Até 30% do seu dinheiro pode ir para jantares com amigos, streaming, roupas novas, e lazer. 
A genialidade deste método é a ausência de culpa: se a sua cota de 30% for de R$ 1.500 por mês, e você usar R$ 500 num jantar excepcional, não precisa sentir peso na consciência. O dinheiro foi destinado a isso desde o primeiro dia do mês.

### 20% para o Futuro (Investimentos e Dívidas)
Este é o dinheiro "intocável". Antes de gastar um único centavo com saídas de fim de semana, você deve pegar 20% do seu salário e usá-lo para investir (construir a Reserva de Emergência, Tesouro Direto, Ações) ou, caso tenha juros correndo contra você, usá-lo para amortizar agressivamente suas dívidas. 
O princípio de ouro aqui é o "Pague-se Primeiro". No dia em que o salário cai, os 20% do futuro devem ser transferidos para a corretora imediatamente.
...
Um planejamento anual sólido antecipa esses eventos. 
**A estratégia do Provisionamento:**
Se o seu IPVA e IPTU somam R$ 3.600 todo início de ano, não tente tirar R$ 3.600 do seu salário apertado de janeiro. 
Pegue o valor (R$ 3.600) e divida por 12 meses (R$ 300). A partir de fevereiro de 2026, você vai incluir R$ 300 nas suas "Despesas Fixas" e enviar esse dinheiro para uma caixinha ou investimento rendendo 100% do CDI. 
...
Planejar o ano financeiro não é sobre adivinhar o futuro, é sobre estar preparado para os ciclos da vida. 
Comece hoje mesmo. Imprima seu extrato, aplique a regra do 50/30/20 e crie a sua caixinha de provisionamento para os impostos do ano que vem. Em 12 meses, você sentirá a maior mudança financeira da sua vida: a transição do desespero constante para a paz de espírito absoluta.
`
};
