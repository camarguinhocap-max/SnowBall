...
export const post: Post = {
  slug: 'tesouro-direto-vs-poupanca-2026',
  title: 'Tesouro Direto vs Poupança em 2026',
  excerpt: 'Por que você está perdendo dinheiro na poupança.',
  date: '25 Mai 2026',
  readTime: '5 min de leitura',
  category: 'Renda Fixa',
  tags: ['tesouro direto', 'poupança'],
  image: '/assets/images/tesouro-direto-vs-poupanca-2026.jpg',
  content: `
...
![Gráficos financeiros mostrando comparação de crescimento](https://images.unsplash.com/photo-1590283603385-17ffb3a7f29f?auto=format&fit=crop&w=1200&q=70)
...
O Tesouro Direto, por sua vez, reflete as taxas de juros de mercado. 
Um **Tesouro Selic** rende praticamente 100% da Selic diária. Mesmo descontando a taxa de custódia da B3 (0,20% ao ano para valores acima de R$ 10.000) e o Imposto de Renda, o rendimento líquido do Tesouro Selic historicamente bate a poupança com folga absurda.
...
Outro detalhe cruel da caderneta de poupança é a famigerada "data de aniversário". 
Se você depositou um dinheiro na poupança no dia 10 e precisar sacá-lo no dia 09 do mês seguinte (após 29 dias), você receberá **zero** de rendimento. O banco embolsa os juros daquele mês e você não ganha absolutamente nada, pois a rentabilidade só é creditada a cada 30 dias fechados.
