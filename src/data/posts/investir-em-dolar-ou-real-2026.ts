...
export const post: Post = {
  slug: 'investir-em-dolar-ou-real-2026',
  title: 'Investir em Dólar ou Real? Como Proteger seu Patrimônio Cambialmente',
  excerpt: 'Entenda quando faz sentido ter parte do patrimônio em dólar, como fazer isso de forma prática no Brasil em 2026, quais ativos usar e os riscos cambiais que você não pode ignorar.',
  tags: ['dólar', 'câmbio', 'diversificação internacional', 'hedge cambial', 'BDRs', 'ETFs'],
  category: 'Investimentos',
  date: '24 Jun 2026',
  readTime: '12 min de leitura',
  image: '/assets/images/investir-em-dolar-ou-real-2026.jpg',
  content: `
O real brasileiro é uma das moedas mais voláteis do mundo. Ao longo das últimas décadas, o Brasil conviveu com hiperinflação, múltiplas crises cambiais, planos econômicos fracassados e períodos de desvalorização abrupta. Para o investidor que pensa em preservar patrimônio no longo prazo, ignorar o risco cambial é um erro estratégico grave.
...
**Vantagens**: Simplicidade. Mesma corretora que você já usa. Regulamentação brasileira.
**Desvantagens**: Spread cambial embutido. Imposto de Renda sobre ganho de capital (15% para vendas acima de R$ 20.000/mês). Rentabilidade em reais mistura variação do ativo + variação cambial.

![Gráfico de câmbio dólar versus real em monitor de computador com luz azul](https://images.unsplash.com/photo-1611974789855-9c2a0a7236a3?auto=format&fit=crop&w=1200&q=70)
...
**Vantagens**: Custo total muito mais baixo. Acesso a toda a bolsa americana e global. Estrutura fiscal americana (sem come-cotas).
**Desvantagens**: Declaração obrigatória de ativos no exterior no Imposto de Renda. Herança sujeita a regras americanas para não-residentes.
